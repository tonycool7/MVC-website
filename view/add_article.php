...
<body>
	...
	<div class='container-fluid'>
		<div class='row'>
			...
			<div class="col-md-10">
				<br>
				<h1>Добавить статьи</h1>
				<div class="row">
					<div class="col-md-12  create_article">
					<script>tinymce.init({ selector:'textarea' });</script>
					
					<form action="/work/admin/article/add" method="post">
						...
						<div class="form-group">
							...
							<input class='form-control' id='descr' type='text' name='description' required>
						</div>
						<div class="form-group">
						...
						<textarea name='content'></textarea required><br>
						<input type="submit" class="btn btn-primary" name='article' value="Создать">
					</form>
					</div>
				</div>
			</div>
